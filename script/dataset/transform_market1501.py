...
def transform_test_set(im_dir):
    ...
    g_im_names = [n for n in g_im_names if not osp.basename(n).startswith('-1')]
    g_im_names.sort()
...
if __name__ == '__main__':
    im_dir = 'dataset/market1501/Market-1501-v15.09.15'
    save_path = 'dataset/market1501/partitions.pkl'
